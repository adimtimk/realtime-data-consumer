...
@Component
@Log4j2
public class CustomerDateProcessor implements Function<KStream<Void, GPSData>, KStream<String, GPSDataCount>> {
	...
	public KStream<String, GPSDataCount> apply(KStream<Void, GPSData> gpsstream) {
		...
		return gpsstream
			...
			.groupBy((u,v)-> v.getCarID(),Grouped.with(Serdes.String(), new JsonSerde<>(GPSData.class)))
			.count()
